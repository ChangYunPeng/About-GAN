...
from Discriminator import C3_Discriminator as Discriminator
...
class DCGAN:
    ...
    def train(self,input_data,input_label,d_iters = 5,iterations =10000 ):
        ...
        summaries_dir = '../MODEL/DCGAN/MULTI_GPU%d.CPTK'%time.time()
...
def run(max_steps = 10000):
    ...
    d_steps = 2
    g_steps = 1
    dcgan = DCGAN(batch_size=batch_size,gpu_num=2,g_lr = 1e-6,d_lr = 1e-6)
    dcgan.set_opt()
